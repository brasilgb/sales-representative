...
export function HeroSection({ trialDays, individualMonthlyPrice }: { trialDays: number; individualMonthlyPrice?: number | string }) {
    ...
    return (
        <section className="relative isolate overflow-hidden bg-[#052e16] pt-20 text-white">
            ...
            <div className="absolute top-16 -right-48 -z-10 size-[38rem] rounded-full bg-green-500/20 blur-[120px]" />
            <div className="absolute -bottom-64 left-1/4 -z-10 size-[32rem] rounded-full bg-lime-400/10 blur-[100px]" />
            ...
            <div className="relative mx-auto grid max-w-[86rem] items-center gap-16 px-5 py-20 sm:px-8 sm:py-28 lg:grid-cols-[0.92fr_1.08fr] lg:px-12">
                <div>
                    <p className="inline-flex items-center gap-2 rounded-full border border-green-300/25 bg-green-300/10 px-4 py-2 text-xs font-extrabold tracking-[0.12em] text-green-200 uppercase">
                    ...
                    <h1 className="mt-7 max-w-3xl text-[clamp(3.5rem,7vw,6.6rem)] leading-[0.88] font-black tracking-[-0.075em] text-balance">
                        Menos planilhas.
                        <span className="mt-2 block text-green-300">Mais vendas.</span>
                    </h1>
                    ...
                    <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                        <Button
                            size="lg"
                            className="h-14 w-full rounded-full bg-green-400 px-7 text-sm font-extrabold text-green-950 shadow-[0_18px_60px_rgba(34,197,94,.2)] transition hover:-translate-y-1 hover:bg-green-300 sm:w-auto"
                            asChild
                        >
                ...
                <div className="relative mx-auto w-full">
                    <div className="absolute -inset-5 rounded-[2.2rem] bg-gradient-to-br from-lime-300/20 via-green-600/5 to-transparent blur-2xl" />
                    ...
                    <div className="absolute -right-3 -bottom-5 rounded-2xl border border-lime-300/20 bg-lime-300 px-4 py-3 text-slate-950 shadow-xl sm:-right-7">
